   ...
   \ \/ / _` | |/ _ \| '__/ _` | '_ \| __|    > < | '_ \  |  _ < / _ \| __|
    ...
    try:
        if menu == 1:
            ...
            print(Fore.CYAN +" This version of the bot is maintained by",Fore.BLUE +"Fums",Fore.CYAN +"and",Fore.BLUE +"WolfAnto")
            print(Fore.BLUE +" Discord :",Fore.YELLOW+ "Fums#0888 | WolfAnto#5183")
            print(Fore.BLUE +"Github :",Fore.YELLOW+ "https://github.com/MrFums | https://github.com/WolfAnto",Style.RESET_ALL)
            print("")
            print(Style.BRIGHT + Fore.RED + "▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄")
            print(Style.BRIGHT,Fore.RED)
            print("")
