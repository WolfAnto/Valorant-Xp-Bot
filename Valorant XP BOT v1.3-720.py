...
class bot:
    ...
    def lobby(self):
        ...
        while True:
            ...
            lobby2 = pyautogui.locateOnScreen("720/lobby.png", confidence=0.6)
    ...
    def ingame(self):
        ...
        while True:
            ...
            ingame2 = pyautogui.locateOnScreen("720/ingame.png", confidence=0.6)
    ...
    def endofthegame(self):
        time.sleep(10)
        while True:
            compteur = pyautogui.locateOnScreen("720/confirm2.png")
            compteur2 = pyautogui.locateOnScreen("720/confirm2.png", confidence=0.6)
    ...
    def result(self):
        ...
        time.sleep(10)
        while True:
            results = pyautogui.locateOnScreen("720/confirm.png")
            results2 = pyautogui.locateOnScreen("720/confirm.png", confidence=0.6)
